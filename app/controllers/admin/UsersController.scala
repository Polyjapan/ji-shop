...
import models.{ClientsModel, JsonClient}
...
/**
  * @author zyuiop
  */
class UsersController @Inject()(cc: ControllerComponents, users: ClientsModel)(implicit mailerClient: MailerClient, ec: ExecutionContext, config: Configuration) extends AbstractController(cc) {
  ...
  def acceptEmail(id: Int): Action[AnyContent] = Action.async {
